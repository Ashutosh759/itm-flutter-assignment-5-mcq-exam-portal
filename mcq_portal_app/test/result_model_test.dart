...
void main() {
  ...
  group('AttemptRow', () {
    test('carries the snapshotted exam title and the auto-submit flag', () {
      final row = AttemptRow.fromJson({
        ...
        'examTitle': 'Midterm',
        'studentId': 's1',
        'studentName': 'Ashutosh759',
        'studentEmail': 'ashutosh759@example.com',
        'status': 'submitted',
        'autoSubmitted': true,
        'score': 17.5,
        'totalMarks': 40,
  ...
  group('AppUser', () {
    test('initials come from the first two words', () {
      expect(
        const AppUser(id: '1', name: 'Ashutosh759', email: 'a@b.c', role: 'student').initials,
        'A',
      );
      expect(
        const AppUser(id: '1', name: 'Ashutosh', email: 'a@b.c', role: 'student').initials,
        'S',
      );
      expect(
    ...
    test('reads the aggregate and its rows', () {
      final report = ExamReport.fromJson({
        ...
        'summary': {
          ...
          'lowestScore': 12.5,
          'passPercentage': 50,
          'topper': {'studentName': 'Ashutosh759', 'score': 30},
        },
        'rows': [
          {
            'attemptId': 'a1',
